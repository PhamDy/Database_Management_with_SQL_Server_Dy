...
INSERT INTO Customers
	VALUES (1, 'Nguyễn Văn An', '111 Nguyễn Trãi, Thanh Xuân, Hà Nội', '1987-11-18');
...
AS
BEGIN
	INSERT INTO Customers(Customer_ID, Customer_name, Address, Birthday)
		VALUES (@Customer_ID, @Customer_name, @Address, @Birthday)
END;
--RUN
EXEC SP_Them_DanhBa 2, 'Phạm Văn Nam', '8A Tôn Thất Thuyết, Cầu Giấy, Hà Nội', '2002-5-9';
SELECT * FROM Customers;
